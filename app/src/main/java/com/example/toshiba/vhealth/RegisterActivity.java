...
public class RegisterActivity extends AppCompatActivity {
    private EditText textEmail, textPassword, textFirstname, textLastname, textDateOfBirth,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("Mesosfer Registration");
        toolbar.setTitleTextColor(ActivityCompat.getColor(this,R.color.darkgrey));
